...
class Analyzer
  def initialize(@ner_alg : String, @max_chars = 5000, @req_delay = 5)
...
OptionParser.parse(ARGV) do |parser|
  parser.banner = "Cách dùng: analyzer_online_ner_only.exe [...]"
...
analyzer = Analyzer.new(ner_alg, max_chars: max_chars, req_delay: req_delay)
